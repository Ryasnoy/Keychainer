...
/// Keychainer is a class to help make Keychain access in Swift more straightforward. It is designed to make accessing the Keychain services more like using NSUserDefaults, which is much more familiar to people.
open class Keychainer {
    ...
    public static let defaultKeychainWrapper = Keychainer.standard
    
    /// Default keychain wrapper access
    public static let standard = Keychainer()
    ...
    private convenience init() {
        self.init(serviceName: Keychainer.defaultServiceName)
    }
    
    /// Create a custom instance of Keychainer with a custom Service Name and optional custom access group.
    ///
    ...
    /// Remove all keychain data added through Keychainer. This will only delete items matching the currnt ServiceName and AccessGroup if one is set.
